        ...
        >
          <div className='relative'>
            ...
            <button
              ...
              className='fixed left-5 top-1/2 transform -translate-y-1/2 text-white text-md cursor-pointer'
            >
              &#10094;
            </button>
            <button
              onClick={goToNext}
              className='fixed right-5 top-1/2 transform -translate-y-1/2 text-white text-md cursor-pointer'
            >
              &#10095;
            </button>
          </div>
